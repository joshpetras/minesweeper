...
var Board = exports.Board = function () {
  ...
  _createClass(Board, [{
    ...
    key: 'flipNeighbors',
    value: function flipNeighbors(rowIndex, columnIndex) {
      var _this2 = this;
      ...
      neighborOffsets.forEach(function (offset) {
        ...
        var neighborColumnIndex = columnIndex + offset[1];
        if (neighborRowIndex >= 0 && neighborRowIndex < numberOfRows && neighborColumnIndex >= 0 && neighborColumnIndex < numberOfColumns) {
          if (_this2._playerBoard[neighborRowIndex][neighborColumnIndex] === ' ') {
            _this2.flipTile(neighborRowIndex, neighborColumnIndex);
          }
        }
      });
    }
    ...
    value: function flipAll() {
      var bombDetector = void 0;
      for (var i = 0; i < this._playerBoard.length; i++) {
        for (var j = 0; j < this._playerBoard[i].length; j++) {
